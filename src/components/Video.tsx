  ...
  return (
    <div className="flex-1">
      <div className="bg-black flex justify-center">
        <div className="h-full w-full max-w-[1100px] max-h-[60vh] bg-violet-500 aspect-video">
          <Player>
      ...
      <div className="p-8 max-w-[1100] mx-auto ">
        <div className="flex items-start gap-16">
          <div className="flex-1">
            ...
            {data.lesson.teacher && (
              <div className="flex items-center gap-4 mt-6 leading-relaxed">
                <img
          ...
          <a className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
            ...
            <div className="py-6 leading-relaxed">
              <strong className="text-2xl">
                Wallpapers Exclusivos do Evento
              </strong>
              <p className="text-sm text-gray-200 mt-2">
                Turbine já seu Desktop
              </p>
            </div>
            <div className="h-full p-6 flex items-center">
              <CaretRight size={24} />
