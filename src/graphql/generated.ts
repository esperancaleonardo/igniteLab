...
export type LessonsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type LessonsQueryQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug: string }> };
...
export const LessonsQueryDocument = gql`
    query lessonsQuery {
...
/**
 * __useLessonsQueryQuery__
 *
 * To run a query within a React component, call `useLessonsQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useLessonsQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLessonsQueryQuery({
 *   variables: {
 *   },
 * });
 */
export function useLessonsQueryQuery(baseOptions?: Apollo.QueryHookOptions<LessonsQueryQuery, LessonsQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LessonsQueryQuery, LessonsQueryQueryVariables>(LessonsQueryDocument, options);
      }
export function useLessonsQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LessonsQueryQuery, LessonsQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LessonsQueryQuery, LessonsQueryQueryVariables>(LessonsQueryDocument, options);
        }
export type LessonsQueryQueryHookResult = ReturnType<typeof useLessonsQueryQuery>;
export type LessonsQueryLazyQueryHookResult = ReturnType<typeof useLessonsQueryLazyQuery>;
export type LessonsQueryQueryResult = Apollo.QueryResult<LessonsQueryQuery, LessonsQueryQueryVariables>;